    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link {{ in_array(request()->route()->getName(), ['admin.users.index', 'admin.users.create', 'admin.users.edit', 'admin.users.show']) ? 'active' : '' }}" data-toggle="collapse" href="#user-management" aria-expanded="{{ in_array(request()->route()->getName(), ['admin.users.index', 'admin.users.create', 'admin.users.edit', 'admin.users.show']) ? 'true' : 'false' }}" aria-controls="user-management">
              <i class="icon-head menu-icon"></i>
              <span class="menu-title">Gestion Utilisateurs</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse {{ in_array(request()->route()->getName(), ['admin.users.index', 'admin.users.create', 'admin.users.edit', 'admin.users.show']) ? 'show' : '' }}" id="user-management">
